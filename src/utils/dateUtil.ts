...
export function formatToDateTime(date?: dayjs.ConfigType | string, format = DATE_TIME_FORMAT): string {
...
export function stringToFormatString(date: string | undefined = undefined, oldFormat=DATE_TIME_FORMAT,newFormat = DATE_TIME): string {
